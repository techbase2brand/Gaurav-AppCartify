...
const HeroSection = ({ title, banner }) => {
  return (
    <div className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex justify-center">
      <Image
        src={banner}
        alt="banner"
        width={1000}
        height={500}
        className="w-full max-h-[800px] object-cover rounded-2xl brightness-50"
      />
      ...
      <div className="relative group">
        ...
        <div className="relative bg-slate-900/90 backdrop-blur-xl rounded-3xl p-4 md:p-12 border border-slate-700/50 shadow-2xl">
          ...
          <ul className="mt-3 ms-2 md:ms-4">
            <p className="text-2xl text-[#96BF48] mb-3" data-aos="fade-left">
              {title}
            </p>
            {clientWants &&
              clientWants.map((data, index) =>
                <li
                  className="mt-1 list-disc text-slate-300"
                  key={index}
                  data-aos="fade-left"
                >
                  <p className="text-slate-300 d text-lg font-semibold">
                    {data}.
                  </p>
                </li>
              )}
  ...
  return (
    <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
      <div className="relative group">
        ...
        <div className="relative bg-slate-900/90 backdrop-blur-xl rounded-3xl p-4 md:p-12 border border-slate-700/50 shadow-2xl">
          <div className="flex items-start mb-6 md:mb-12" data-aos="fade-up">
          ...
          <div className=" flex flex-wrap gap-8 justify-center">
            {solutions &&
              solutions.map((solution, index) =>
                <div
                  key={index}
                  className="group/card relative cursor-pointer  w-full md:w-[48%] xl:w-[31%]"
                  data-aos="zoom-in"
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                <button className="relative px-3 md:px-8 py-0 md:py-2 text-[#82bc29] border-2 border-[#82bc29] rounded-lg uppercase font-medium overflow-hidden transition-colors duration-300 group">
                  <span className="absolute inset-0 bg-[#82bc29] transition-all duration-300 transform translate-x-full group-hover:translate-x-0" />
...
export default function Casestudydetail() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <HeroSection title={caseStudy.title} banner={caseStudy.bannerImage} />
      <ClientOverview
